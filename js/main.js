...
function pre_loader() {
	if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
		...
		if(window.innerWidth >= "800") {
			...
			document.getElementById('main|navbar|titletransparent|title').style.width=window.innerWidth-"150"+"px";
			document.getElementById('main|navbar|titletransparent|title').style.left="60px";
			...
			document.getElementById('main|navbar|titletransparent|title').style.width=window.innerWidth-"30"+"px";
			document.getElementById('main|navbar|titletransparent|title').style.left="0px";
		}
	}
}
