...
function pre_loader() {
	if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
		...
		if(window.innerWidth >= "800") {
			...
			document.getElementById('navbar').style.width=window.innerWidth-"180"+"px";
			document.getElementById('navbar').style.left="60px";
			document.getElementById('titletransparent').style.width=window.innerWidth-"130"+"px";
			document.getElementById('titletransparent').style.left="60px";
			document.getElementById('title').style.width=window.innerWidth-"200"+"px";
