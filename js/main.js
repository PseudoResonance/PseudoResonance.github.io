...
function pre_loader() {
	if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
		...
		if(window.innerWidth >= "800") {
			...
			document.getElementById('navbar').style.width=window.innerWidth-"150"+"px";
			document.getElementById('navbar').style.left="60px";
			document.getElementById('titletransparent').style.width=window.innerWidth-"150"+"px";
			document.getElementById('titletransparent').style.left="60px";
			document.getElementById('title').style.width=window.innerWidth-"150"+"px";
			...
			document.getElementById('navbar').style.width=window.innerWidth-"30"+"px";
			document.getElementById('navbar').style.left="0px";
			document.getElementById('titletransparent').style.width=window.innerWidth-"30"+"px";
			document.getElementById('titletransparent').style.left="0px";
			document.getElementById('title').style.width=window.innerWidth-"30"+"px";
